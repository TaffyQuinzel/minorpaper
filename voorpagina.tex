...
{\LARGE SAD Minor\\ [0.3\baselineskip] Testing Expressivity }\\[0.2\baselineskip] % Title

\rule{\textwidth}{0.4pt}\vspace*{-\baselineskip}\vspace{3.2pt} % Thin horizontal line
\rule{\textwidth}{1.6pt}\\[\baselineskip] % Thick horizontal line

\scshape % Small caps
Adventures in MetaCompiler of \\Louis van der Burg\\[\baselineskip] % Tagline(s) or further description
